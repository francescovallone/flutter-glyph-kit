...
void main() {
  final GlyphInterfaceSdkPlatform initialPlatform =
      GlyphInterfaceSdkPlatform.instance;
  ...
  test('getPlatformVersion', () async {
    ...
    MockGlyphInterfaceSdkPlatform fakePlatform =
        MockGlyphInterfaceSdkPlatform();
